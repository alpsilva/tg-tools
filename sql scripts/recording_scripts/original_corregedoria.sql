...
SELECT record_execution_time(10, 44508, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
...
SELECT record_execution_time(10, 8380, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
    anon_1.earliest_date,
...
SELECT record_execution_time(10, 18104, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
    anon_1.earliest_date,
...
SELECT record_execution_time(10, 17384, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
    anon_1.earliest_date,
...
SELECT record_execution_time(10, 14013, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
    anon_1.earliest_date,
...
SELECT record_execution_time(10, 3843, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
    anon_1.earliest_date,
...
SELECT record_execution_time(10, 7433, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
    anon_1.earliest_date,
...
SELECT record_execution_time(10, 14009, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
    anon_1.earliest_date,
...
SELECT record_execution_time(10, 18228, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
    anon_1.earliest_date,
...
SELECT record_execution_time(10, 13325, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
    anon_1.earliest_date,
...
SELECT record_execution_time(10, 18007, 'corregedoria', 'original', '
    SELECT
    proc."NPU",
    proc."processoID",
    anon_1.earliest_date,
